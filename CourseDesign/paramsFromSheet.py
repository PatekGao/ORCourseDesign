...
flightSheet = [
    ...
    [4, 'NH968', 'PVG', '1:35', 'HND', '5:30', True],
    [5, 'NH919', 'NRT', '9:20', 'PVG', '11:40', True],
    [6, 'NH920', 'PVG', '13:05', 'NRT', '16:55', True],
    [7, 'NH973', 'KIX', '9:00', 'PVG', '10:35', False],
    [8, 'NH974', 'PVG', '11:35', 'KIX', '14:55', False],
    [9, 'NH961', 'HND', '8:55', 'PEK', '12:00', True],
    [10, 'NH962', 'PEK', '15:10', 'HND', '19:45', True],
    [11, 'NH955', 'NRT', '9:00', 'PEK', '12:05', False],
    ...
    [17, 'NH927', 'NRT', '9:45', 'TAO', '12:30', False],
    [18, 'NH928', 'TAO', '13:30', 'NRT', '17:35', False],
    [19, 'NH933', 'NRT', '9:10', 'CAN', '13:05', True],
...
flightSheet = np.array(flightSheet)
